    ...
    def parse(self, response):
        for team in response.xpath("//tbody/tr"):
            yield {
                ...
                'total_stl': team.xpath("./td/text()")[1].get(),
                'last_three_stl': team.xpath("./td/text()")[2].get(),
                'last_stl': team.xpath("./td/text()")[3].get(),
                'home_stl': team.xpath("./td/text()")[4].get(),
                'away_stl': team.xpath("./td/text()")[5].get()
            }